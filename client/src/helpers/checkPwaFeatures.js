export const checkIsWindowAvailable = () => typeof window !== 'undefined';

const checkIsServiceWorkerAvailable = () =>
  checkIsWindowAvailable() && navigator.serviceWorker;
...
export const checkIsWebPushSupported = () =>
    checkIsServiceWorkerAvailable() && 'PushManager' in window && 'Notification' in window;
